...
public class Load extends Command{
    ...
    public Request execute(Request args){
        ...
        try {
            ResultSet collection = DBConnection.connect().createStatement().executeQuery("SELECT id, owner, name, creation_date, height, birthday, weight, coord_x, coord_y, loc_x, loc_y, loc_name, color");
